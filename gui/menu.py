...
def build_menu(app: MyNotesApp) -> None:
    ...
    file_menu.addAction(_action(app, "Esporta tutte (cartelle)...", lambda: app.export_ctl.export_all_structured()))
    file_menu.addSeparator()
    ...
    backup_menu.addAction(_action(app, "Log backup...", lambda: app.backup_ctl.show_backup_log()))
    backup_menu.addSeparator()
